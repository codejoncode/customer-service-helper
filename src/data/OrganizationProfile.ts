...
import { ClosingChecklistItem, sampleEndCallFlow } from "./ClosingChecklistItem";
...
export interface OrganizationProfile {
  ...
  actions: Action[];
  articles: Article[];
  endCallFlow: ClosingChecklistItem[];
  reasonsForCall: CallReason[];
}

export const sampleOrganization: OrganizationProfile = {
  id: "org-healthsecure",
  name: "HealthSecure",
  agents: [
    {
